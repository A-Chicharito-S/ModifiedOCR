...
def get_args_from_input():
    ...
    parser.add_argument('--hidden_layers', metavar='', type=ast.literal_eval,
    ...
    parser.add_argument('--save_dataset_name', type=str,
                        help='a more specified saving dir for the rewired data of borf')
    parser.add_argument('--use_edge_weight', type=int,
                        help='specify whether use edge weights or not, if True, meaning using GCNConv only')
